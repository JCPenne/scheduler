...
storiesOf('InterviewerList', module)
  ...
  .add('Clickable', () => (
    <InterviewerListItem interviewers={interviewers} onChange={() => action('setInterviewer')(interviewer.id)} />
  ));
...
storiesOf('Appointment', module)
  ...
  .add('Empty', () => <Empty onAdd={action('Appointment Added')} />)
  .add('Show', () => (
    <Show
  ...
  .add('Create', () => <Form interviewers={interviewers} onSave={action('On Save')} onCancel={action('On Cancel')} />)
